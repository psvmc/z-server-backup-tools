...
import FolderZipStartModal from "./FolderZipStartModal.vue";
import { folderZipBackupPanelProps, useFolderZipBackupPanel } from "./FolderZipBackupPanel";

const props = defineProps(folderZipBackupPanelProps);
...
const {
  ...
  onConfirmStart,
  onStop,
} = useFolderZipBackupPanel(props, emit);
</script>

<template>
  <section class="panel-card panel-card--grow folder-zip-backup-panel">
    <div class="folder-zip-backup-panel__content">
      <div class="panel-card-body folder-zip-backup-panel__body">
        <BackupTaskList
          variant="folder_zip"
          :tasks="tasks"
        ...
        <div class="folder-zip-backup-panel__main">
          <div class="grid grid-cols-2 lg:grid-cols-5 gap-3">
            ...
            <div class="rounded-lg border border-blue-100/80 bg-white/60 px-3 py-2 min-w-0">
              <div class="text-xs text-gray-500 mb-1">本机压缩包</div>
          ...
          <div class="flex flex-wrap gap-2 items-center">
            <a-button type="primary" :disabled="startDisabled" @click="onStart">开始备份</a-button>
...
<style scoped>
.folder-zip-backup-panel {
  display: flex;
  flex-direction: column;
  min-height: 0;
}

.folder-zip-backup-panel__content {
  flex: 1 1 0;
  min-height: 0;
  display: flex;
  flex-direction: column;
